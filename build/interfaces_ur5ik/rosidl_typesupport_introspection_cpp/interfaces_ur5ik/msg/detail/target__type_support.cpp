...
{
  new (message_memory) interfaces_ur5ik::msg::Target(_init);
}

void Target_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces_ur5ik::msg::Target *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Target_message_member_array[1] = {
  {
    ...
    offsetof(interfaces_ur5ik::msg::Target, target),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Target_message_members = {
  "interfaces_ur5ik::msg",  // message namespace
  "Target",  // message name
  1,  // number of fields
  sizeof(interfaces_ur5ik::msg::Target),
...
{
  return &::interfaces_ur5ik::msg::rosidl_typesupport_introspection_cpp::Target_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_ur5ik, msg, Target)() {
  return &::interfaces_ur5ik::msg::rosidl_typesupport_introspection_cpp::Target_message_type_support_handle;
}
