...
#include "interfaces_ur5ik/msg/detail/target__rosidl_typesupport_fastrtps_c.h"
...
using _Target__ros_msg_type = interfaces_ur5ik__msg__Target;
...
size_t get_serialized_size_interfaces_ur5ik__msg__Target(
  const void * untyped_ros_message,
...
static uint32_t _Target__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_ur5ik__msg__Target(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces_ur5ik
size_t max_serialized_size_interfaces_ur5ik__msg__Target(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_ur5ik__msg__Target;
    is_plain =
      (
...
static size_t _Target__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_ur5ik__msg__Target(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_ur5ik, msg, Target)() {
